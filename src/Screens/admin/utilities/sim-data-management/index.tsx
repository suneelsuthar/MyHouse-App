...
export const AdminSimDataManagement: React.FC = () => {
  return (
    ...
    >
      <Header2 title="Sim Data Management" onNotificationPress={() => {}} />
      <View style={styles.content}>
        <Text style={styles.pageTitle}>Sim Data Management</Text>
        <Text style={styles.description}>
          This screen will manage SIM card data and connectivity.
        </Text>
      </View>
    </Screen>
  );
