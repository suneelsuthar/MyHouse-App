...
const $sizeStyles = {
  xxxl: { fontSize: 34, lineHeight: 44 } satisfies TextStyle,
  xxxii: { fontSize: 30, lineHeight: 40 } satisfies TextStyle,
  xxl: { fontSize: 24, lineHeight: 40 } satisfies TextStyle,
  xl: { fontSize: 22, lineHeight: 34 } satisfies TextStyle,
  lg: { fontSize: 18, lineHeight: 32 } satisfies TextStyle,
